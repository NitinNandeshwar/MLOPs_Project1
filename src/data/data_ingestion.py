...
def preprocess_data(df:pd.DataFrame) -> pd.DataFrame:
    """ Preprocess the data. """
    try:
        # df.drop(columns=["tweer_id"],inplace=True)
...
def main():
    try:
        ...
        df = load_data(data_url='https://raw.githubusercontent.com/NitinNandeshwar/MLOPs_Project1/refs/heads/main/notebooks/data.csv')
